 ...
 *       {@link com.xilidou.marvis.http.AnthropicException#isPromptTooLong()}
 ...
 * 由 {@link com.xilidou.marvis.compact.CompactConfiguration#compactPipeline(CompactConfig,
 * com.xilidou.marvis.http.AnthropicClient, com.xilidou.marvis.MarvisProperties)}
 * 通过 {@code @Bean} 装配。
 */
public class CompactPipeline {
     ...
     *
     * <p>调用方:{@link com.xilidou.marvis.agent.AgentLoopHarness} 在收到
     * {@link com.xilidou.marvis.http.AnthropicException#isPromptTooLong()}
     * 时调用此方法,然后重试 LLM 请求。
     *
