 ...
 *
 * <p>跟 {@link com.xilidou.marvis.memory.MemoryConfiguration} 1:1 模式:
 * <ul>
 *   <li>{@link TaskConfig} —— 从 {@link MarvisProperties.Tasks} 转出</li>
 *   <li>{@link TaskStore} —— 接收 {@link TaskConfig} + {@code marvisObjectMapper}</li>
...
public class TasksConfiguration {
    ...
    @Bean
    public TaskConfig taskConfig(MarvisProperties props) {
