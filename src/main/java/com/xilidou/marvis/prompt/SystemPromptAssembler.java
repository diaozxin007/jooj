package com.xilidou.marvis.prompt;
...
import com.xilidou.marvis.http.dto.CacheControl;
import com.xilidou.marvis.http.dto.SystemTextBlock;
 ...
 * <h3>解决的问题</h3>
 *
 * <p>切片 C 完成后,marvis 的 SYSTEM 是 {@code @PostConstruct} 一次性算好的快照,
 ...
 * <h3>线程安全</h3>
 *
 * <p>缓存字段用 {@code volatile} 保护可见性。当前 marvis Loop 是单线程,
...
public class SystemPromptAssembler {
    ...
    private final MarvisProperties.Prompt template;
    ...
    public SystemPromptAssembler(MarvisProperties props,
     ...
     * 才能命中。marvis 现在 Block 1 仅 ~500 token,Anthropic 会**静默忽略**
     ...
     *
     * <ul>
     *   <li>identity / tools — 直接用 {@link MarvisProperties.Prompt} 的模板</li>
