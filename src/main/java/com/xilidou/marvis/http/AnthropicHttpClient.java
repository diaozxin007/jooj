 ...
 *   <li><b>切片 C 之后:由 {@link com.xilidou.marvis.http.HttpClientConfig#anthropicClient}
...
public class AnthropicHttpClient implements AnthropicClient {
    ...
    public CreateMessageResponse createMessage(CreateMessageRequest req) {
        try {
            ...
            // 启用方式:在 logback.xml 把 com.xilidou.marvis.http 设为 DEBUG
            // 或传 -Dlogging.level.com.xilidou.marvis.http=DEBUG
     ...
     * Spring 场景由 {@link com.xilidou.marvis.http.HttpClientConfig#okHttpClient()}
     * 提供等价的 Bean。
     */
