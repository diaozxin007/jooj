...
/**
 * jooj 统一线程模型 —— 替代 4 处 {@code new Thread().setDaemon(true).start()}。
 *
 * <h3>分三类池(Stage 3 拆分)</h3>
 *
 * <ul>
 *   <li><b>{@link #joojTaskScheduler() taskScheduler}</b> ——
 ...
 * jooj 4.x Spring Boot 默认不开 scheduling,要显式 enable。
 *
 * <h3>Spring 接管生命周期</h3>
 *
 * <ul>
...
@EnableScheduling
@Slf4j
public class JoojExecutors {

    public static final String SCHEDULER_BEAN = "joojTaskScheduler";
    public static final String BG_BEAN = "joojBgExecutor";
    public static final String TEAMMATE_BEAN = "joojTeammateExecutor";
    ...
    public ExecutorService joojBgExecutor(JoojProperties props) {
        ...
        ThreadPoolExecutor pool = new ThreadPoolExecutor(
                ...
                namedDaemonThreadFactory("jooj-bg-"),
    ...
    public ExecutorService joojTeammateExecutor(JoojProperties props) {
        ...
        ThreadPoolExecutor pool = new ThreadPoolExecutor(
                ...
                60L, TimeUnit.SECONDS,
                new SynchronousQueue<>(),
                namedDaemonThreadFactory("jooj-teammate-"),
