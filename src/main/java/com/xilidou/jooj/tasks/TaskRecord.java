 ...
 *       jooj 工程化扩展会想加的"漂亮东西",但 s12 教学版不要</li>
 * </ul>
 *
 * <p>Jackson 反序列化兼容:
 * <ul>
...
public class TaskRecord {
     ...
     *
     * <p>jooj 是单 agent loop,这个字段实际上恒为 {@code "agent"} 或 {@code null};
     ...
     * Teammate claim 此 task 时,jooj 会构造
     * {@link com.xilidou.jooj.tool.ExecutionContext#inWorktree} 让后续工具调用切到
