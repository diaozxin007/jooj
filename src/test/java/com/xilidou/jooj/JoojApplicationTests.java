 ...
 * 里面的 fake api-key + test-model 让 {@link com.xilidou.jooj.http.AnthropicProperties} /
 * {@link com.xilidou.jooj.http.HttpClientConfiguration}
 * 装配通过,不依赖真实环境变量。
 *
