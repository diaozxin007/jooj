...
class RecoveryCoordinatorTest {
    ...
    private MarvisProperties.Recovery recoveryCfg;
    ...
    @BeforeEach
    void setup() {
        recoveryCfg = new MarvisProperties.Recovery();
        ...
        MarvisProperties props = new MarvisProperties();
     ...
     */
    private RecoveryCoordinator newCoordinator(MarvisProperties props, boolean hasReactiveSupport) {
    ...
    private MarvisProperties propsWith(MarvisProperties.Recovery cfg) {
        var p = new MarvisProperties();
        p.setRecovery(cfg);
        return p;
    }
}
